...
class SiswaControllers extends Controller
{
    ...
    public function index()
    {
        ...
        $siswa = Siswa::groupBy('gender')
        ->get([DB::raw('IF(gender = "perempuan", "Perempuan", "Laki-laki") as gender, count(gender) as total')])
        ->pluck('total', 'gender');
        ...
        $data = $siswa->values();
        // dd($siswa);
        return view ('sisw.index',compact('labels','data','sisw'))->with('i', (request()->input('page', 1) -1) * 5);
    }
